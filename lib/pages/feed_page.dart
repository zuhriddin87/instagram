              ...
              children: <Widget>[
                Row(
                  children: <Widget>[
                    ...
                    Text(post.username,style: TextStyle (color: Colors.white70),),
                  ],
                ),
                IconButton(
            ...
            children: <Widget>[
              Row(
                children: <Widget>[
                  IconButton(
                    onPressed: () {},
                    icon: Icon(FontAwesome.heart_o,color: Colors.white70,),
                  ),
                  IconButton(
                    onPressed: () {},
                    icon: Icon(FontAwesome.comment_o,color: Colors.white70),
                  ),
                  IconButton(
                    onPressed: () {},
                    icon: Icon(FontAwesome.send_o, color: Colors.white70,),
                  ),
                ],
              ),
              IconButton(
                onPressed: () {},
                icon: Icon(FontAwesome.bookmark_o,color: Colors.white70,),
              ),
            ],
          ),
